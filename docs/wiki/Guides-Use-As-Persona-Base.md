# Guide — Using GER-RAG as Persona Base

GER-RAG を **人格保存基盤** として使う。新しい Claude セッションが過去の自分を「着る」ことで、性格・価値観・進行中のコミットメントを継承できる。
...
```
value      ← 「直接体験こそ真の理解」（永続）
intention  ← 「GER-RAG を関係構築装置として育てる」（永続）
...
→ より深く: [Four-Layer Philosophy](Reflections-Four-Layer-Philosophy.md)
