...
- [Phase L — Hybrid Retrieval](Plans-Phase-L-Hybrid-Retrieval.md) — embedder の hidden ranking 限界を BM25 lexical metric の union seed で構造的に拡張（Stage 1 設計中）
