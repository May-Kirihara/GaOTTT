...
- [Phase M — Mass Conservation](Plans-Phase-M-Mass-Conservation.md) — 「自己関与は mass を生まない」単一規則で mass 蓄積の chunk 内輪取引を構造的に矯正、Articulation as Carrier の literal な物理実装 (起草中)
